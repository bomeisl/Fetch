...
import com.example.fetchapprenticeshiptest.ui.theme.Forest2
import kotlinx.coroutines.flow.StateFlow

@Composable
fun HomeScreen2(item2List: StateFlow<List<Item_DB>>) {
...
@Composable
fun ItemCard2(item: Item_DB) {
    Card(
        modifier = Modifier
            .padding(10.dp),
        colors = CardDefaults.cardColors(
            contentColor = Color.Black,
            containerColor = Forest2,
        )
    ) {
        Column(
            modifier = Modifier
